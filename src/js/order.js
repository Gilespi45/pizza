...
function Order() {
  ...
  return (
    <div>
      ...
      <div className="cards">
        {pizza.map((pizzaItem) => (
          <div className="card" key={pizzaItem._id}>
            <div>
              ...
              <p>
                ...
                <button type="button" onClick={() => BuyNow(pizzaItem._id)}>
                  Buy Now
                </button>
              </p>
            </div>
            ...
            <tr key={order._id}>
              ...
              <td>
                {editOrderId === order._id ? (
                  ...
                  <>
                    <button type="button" onClick={() => EditOrder(order._id, order.qty)}>
                      Edit
                    </button>
      ...
      <button type="button" onClick={DeleteAllOrders}>
        Delete All Orders
      </button>
    </div>
  );
